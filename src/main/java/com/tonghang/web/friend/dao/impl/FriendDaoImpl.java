...
//		}
		...
		List<Invitation> invitations = sessionFactory.getCurrentSession().createQuery("from Invitation as invitation where invitation.invitee.client_id = :client_id").setParameter("client_id", client_id).list();
//		session.close();
		return invitations;
	}
